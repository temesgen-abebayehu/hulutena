      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'>
        {[...Array(4)].map((_, index) => (
          <div key={index} className='flex flex-col items-center p-6 border rounded-lg bg-white shadow-md'>
            ...
            <p className='text-gray-600 flex flex-row items-center gap-2'>General Practitioner <FaCheckCircle color='green' size={20} /></p>
            ...
            <a className='text-blue-500 hover:underline mt-2' href="/profile">See Profile</a>
